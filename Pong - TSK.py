...
# Artificial Intelligence Fundamentals - Assignment 5 - TSK
...
class FuzzyPlayer(Player):
    def __init__(self, racket: Racket, ball: Ball, board: Board):
        ...
        output['right'] = fuzz.trimf(output.universe, [-46, -45, -44])
        output['center'] = fuzz.trimf(output.universe, [-1, 0, 1])
        output['left'] = fuzz.trimf(output.universe, [44, 45, 46])
